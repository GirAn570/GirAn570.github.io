...
const translations = {
  en: {
    ...
    hero: {
      ...
      cvButtonFr: 'Download CV (FR)',
      cvLinkFr: '/assets/docs/CV-Français.pdf'
    },
    sections: {
    ...
    skills: {
      ...
      catOther: 'Other',
      skStorage: 'NAS / Storage',
      skHardware: 'Computer & Server Hardware',
      skItInfra: 'IT Infrastructure',
      skDbDesign: 'Database Design',
      skResourcePlanning: 'Resource Planning',
      skDocumentation: 'Documentation'
    },
    timeline: {
    ...
    projects: {
      ...
      modalReflection: 'Personal Reflection',
      modalDocuments: 'Documents',
      modalPdf: 'PDF',
      modalVideo: 'Video demo',
      modalBadges: 'Technologies & Skills',
      modalClose: 'Close',
      typeSchool: 'School',
  ...
  fr: {
    ...
    hero: {
      ...
      cvLink: '/assets/docs/CV-English.pdf',
      cvButtonFr: 'Télécharger le CV (FR)',
      cvLinkFr: '/assets/docs/CV-Français.pdf'
    },
    sections: {
    ...
    skills: {
      catCloud: 'Cloud',
      catVirtualization: 'Virtualisation',
      catSystems: 'Systèmes',
      catNetworking: 'Réseau',
      catScripting: 'Scripting',
      catProgramming: 'Programmation',
      catOffice: 'Bureautique',
      catManagement: 'Gestion',
      catOther: 'Autres',
      skStorage: 'NAS / Stockage',
      skHardware: 'Matériel informatique & serveurs',
      skItInfra: 'Infrastructure IT',
      skDbDesign: 'Conception de bases de données',
      skResourcePlanning: 'Planification des ressources',
      skDocumentation: 'Documentation'
    },
    timeline: {
      ...
      klepperDate: '2x une semaine en 2021 & 2022',
    ...
    projects: {
      ...
      modalDateLabel: 'Date',
      modalDescription: 'Description',
      modalReflection: 'Réflexion personnelle',
      modalDocuments: 'Documents',
      modalPdf: 'PDF',
      modalVideo: 'Démo vidéo',
      modalBadges: 'Technologies & Compétences',
      modalClose: 'Fermer',
      typeSchool: 'École',
  ...
  de: {
    ...
    hero: {
      ...
      cvLink: '/assets/docs/CV-English.pdf',
      cvButtonFr: 'Lebenslauf (FR) herunterladen',
      cvLinkFr: '/assets/docs/CV-Français.pdf'
    },
    sections: {
    ...
    skills: {
      catCloud: 'Cloud',
      catVirtualization: 'Virtualisierung',
      catSystems: 'Systeme',
      catNetworking: 'Netzwerk',
      catScripting: 'Scripting',
      catProgramming: 'Programmierung',
      catOffice: 'Office',
      catManagement: 'Management',
      catOther: 'Sonstiges',
      skStorage: 'NAS / Speicher',
      skHardware: 'Computer- & Server-Hardware',
      skItInfra: 'IT-Infrastruktur',
      skDbDesign: 'Datenbankdesign',
      skResourcePlanning: 'Ressourcenplanung',
      skDocumentation: 'Dokumentation'
    },
    timeline: {
    ...
    projects: {
      ...
      noResults: 'Keine Projekte passen zu diesem Filter.',
      ...
      modalDescription: 'Beschreibung',
      modalReflection: 'Persönliche Reflexion',
      modalDocuments: 'Dokumente',
      modalPdf: 'PDF',
      modalVideo: 'Video-Demo',
      modalBadges: 'Technologien & Fähigkeiten',
  ...
  lb: {
    ...
    certificationsPage: {
      ...
      filterTitle: 'Filteren & sortéieren',
      categoryTitle: 'Kategorie',
      statusTitle: 'Status',
      tagTitle: 'Tags',
    ...
    skills: {
      catCloud: 'Cloud',
      catVirtualization: 'Virtualiséierung',
      catSystems: 'Systemer',
      catNetworking: 'Netzwierk',
      catScripting: 'Scripting',
      catProgramming: 'Programméierung',
      catOffice: 'Office',
      catManagement: 'Gestioun',
      catOther: 'Anerer',
      skStorage: 'NAS / Späicher',
      skHardware: 'Computer- & Server-Hardware',
      skItInfra: 'IT-Infrastruktur',
      skDbDesign: 'Datebankdesign',
      skResourcePlanning: 'Ressourceplanung',
      skDocumentation: 'Dokumentatioun'
    },
    timeline: {
      educationHeading: 'Ausbildung',
    ...
    projects: {
      ...
      noResults: 'Keng Projeten passen zu dësem Filter.',
      viewMore: 'Méi gesinn',
      viewDetails: 'Detailer gesinn',
      openPdf: 'PDF opmaachen',
      filterStatusAll: 'All Status',
      filterCompleted: 'Ofgeschloss',
      filterInProgress: 'Am Gaang',
      statusCompleted: 'Ofgeschloss',
      statusInProgress: 'Am Gaang',
      modalTypeLabel: 'Typ',
      modalDateLabel: 'Datum',
      modalDescription: 'Beschreiwung',
      modalReflection: 'Perséinlech Reflexioun',
      modalDocuments: 'Dokumenter',
      modalPdf: 'PDF',
      modalVideo: 'Video-Demo',
      modalBadges: 'Technologien & Fäegkeeten',
      modalClose: 'Zoumaachen',
      typeSchool: 'Schoul',
      typePersonal: 'Perséinlech'
    },
    contact: {
      emailLabel: 'Email',
      linkedinLabel: 'LinkedIn'
...
function updateContent(lang) {
  ...
  const cvButtonFr = document.querySelector('[data-i18n="hero.cvButtonFr"]');
  if (cvButtonFr) {
    cvButtonFr.textContent = translations[lang].hero.cvButtonFr;
    cvButtonFr.href = translations[lang].hero.cvLinkFr;
  }
